module github.com/Recall-Kitchen/rk-mcp/examples/go

go 1.26.1

replace github.com/Recall-Kitchen/rk-mcp/go => ../../go/
...
require (
	...
	github.com/ProjectZKM/Ziren/crates/go-runtime/zkvm_runtime v0.0.0-20260902013009-47d4ca806d93 // indirect
